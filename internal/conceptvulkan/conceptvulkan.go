...
#define PROM_CONCEPT_VULKAN_M1D_TRACE(event) prom_concept_vulkan_m1d_trace_event(event)
#else
#define PROM_CONCEPT_VULKAN_M1D_TRACE(event) ((void)0)
#endif
...
int prom_concept_vulkan_kernel54_execute(const prom_vk_runtime_services* services, prom_shader_package* package, VkAccelerationStructureKHR admitted_tlas, uint32_t* out_evidence) {
  ...
  *out_evidence = 0u;
  ...
  PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_EVIDENCE);
  ...
  PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_DESCRIPTORS);
  ...
  PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_PIPELINE);
  ...
  PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_COMMAND_ALLOCATE); PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_COMMAND_BEGIN); PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_TLAS_READ); PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_EVIDENCE_WRITE); PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_DISPATCH); PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_COMMAND_END);
  ...
  PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_SUBMIT_WAIT); PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_OBSERVE);
cleanup:
  PROM_CONCEPT_VULKAN_M1D_TRACE(PROM_CONCEPT_VULKAN_M1D_CLEANUP);
