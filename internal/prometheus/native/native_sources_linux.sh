...
PROMETHEUS_COMMON_C=(
  ...
  "$NATIVE_DIR/reactor_vulkan_runtime.c"
  ...
  "$NATIVE_DIR/reactor_vulkan_model_block.c"
...
PROMETHEUS_MARIONETTE_CPP=(
  ...
  "$NATIVE_DIR/Marionette/ray_query_public_api_tests.cpp"
  "$NATIVE_DIR/Marionette/ray_query_batch_dispatch_tests.cpp"
  ...
  "$NATIVE_DIR/Marionette/reactor_model_block_tests.cpp"
)
