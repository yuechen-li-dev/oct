...
if "%PROMETHEUS_DVT2_M5B_SUBGROUP_OWNED_EXPERIMENT%"=="1" if "%PROMETHEUS_DVT2_M5B_GEMINI_EXACT_EXPERIMENT%"=="1" (
...
call "%CC%" /nologo /TC /std:c11 /O2 /W4 /DPROMETHEUS_REACTOR_BUILD_DLL %PROMETHEUS_MX5_CONTROL_DEFINE% %PROMETHEUS_M5B_EXPERIMENT_DEFINE% %PROMETHEUS_M5B_GEMINI_EXACT_DEFINE% /c %VULKAN_INCLUDE% /Fo"%OBJ_DIR%\\" %PROMETHEUS_COMMON_C_SRCS%
...
call :build_marionette "%MARIONETTE_EXE%" "%MARIONETTE_PDB%" %PROMETHEUS_MARIONETTE_MAIN% "/DMARIONETTE_EXCLUDE_SLOW_TESTS /DMARIONETTE_EXCLUDE_BENCHMARK_TESTS %PROMETHEUS_MX5_CONTROL_DEFINE% %PROMETHEUS_M5B_EXPERIMENT_DEFINE% %PROMETHEUS_M5B_GEMINI_EXACT_DEFINE%" ""
