...
enum {
  ...
  PROM_DOM_KEY_INDEX_SLOT_SWAP_COUNT = 134,
  PROM_DOM_KEY_INDEX_SLOT_MAX_WIP_DEPTH = 135,
  PROM_DOM_KEY_INDEX_SLOT_OVERWRITE_REJECTION_COUNT = 136,
  PROM_DOM_KEY_INDEX_SLOT_STALE_BUFFER_REJECTION_COUNT = 137,
  PROM_DOM_KEY_INDEX_SLOT_SHAPE_INVALIDATION_COUNT = 138,
  PROM_DOM_KEY_INDEX_SLOT_LAYOUT_INVALIDATION_COUNT = 139,
  PROM_DOM_KEY_INDEX_SLOT_CAPACITY_INVALIDATION_COUNT = 140,
  PROM_DOM_KEY_INDEX_SLOT_INFLIGHT_REJECTION_COUNT = 141,
  PROM_DOM_KEY_INDEX_SLOT_CLEANUP_SUCCESS_COUNT = 142,
  PROM_DOM_KEY_INDEX_SLOT_FAILURE_SLOT_ID = 143,
  PROM_DOM_KEY_INDEX_SLOT_FAILURE_REASON_GLOBAL = 144,
  PROM_DOM_KEY_INDEX_ASYNC_TASK_ID = 145,
  PROM_DOM_KEY_INDEX_ASYNC_LIFECYCLE_STATE = 146,
  PROM_DOM_KEY_INDEX_ASYNC_STAGE = 147,
  PROM_DOM_KEY_INDEX_ASYNC_DETAIL = 148,
  PROM_DOM_KEY_INDEX_ASYNC_READY = 149,
  PROM_DOM_KEY_INDEX_ASYNC_FAILED = 150,
  PROM_DOM_KEY_INDEX_ASYNC_CONSUMED = 151,
  PROM_DOM_KEY_INDEX_ASYNC_OUTSTANDING_TASKS = 152,
  PROM_DOM_KEY_INDEX_ASYNC_FAILURE_STAGE = 153,
  PROM_DOM_KEY_INDEX_ASYNC_FAILURE_DETAIL = 154,
  PROM_DOM_KEY_INDEX_ASYNC_SUBMIT_DETAIL = 155,
  PROM_DOM_KEY_INDEX_ASYNC_QUERY_DETAIL = 156,
  PROM_DOM_KEY_INDEX_ASYNC_SLOT_ID = 157,
  PROM_DOM_KEY_INDEX_ASYNC_SLOT_GENERATION = 158,
  PROM_DOM_KEY_INDEX_ASYNC_OWNS_SLOT = 159,
  PROM_DOM_KEY_INDEX_ASYNC_TRANSFER_COMPLETE = 160,
  PROM_DOM_KEY_INDEX_ASYNC_COMPUTE_COMPLETE = 161,
  PROM_DOM_KEY_INDEX_ASYNC_READBACK_COMPLETE = 162,
  PROM_DOM_KEY_INDEX_COUNT = 163,
};
