...
enum {
  ...
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_WORKER_ID = 163,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_SLOT_ID = 164,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_ENTRY_ID = 165,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_SHAPE_CLASS = 166,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DEVICE_BAND = 167,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_SELECTED_RECIPE_VARIANT = 168,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_REQUESTED_RESOURCE_CLASS = 169,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_REGISTER_PRESSURE_CLASS = 170,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_SHARED_MEMORY_PRESSURE_CLASS = 171,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_MEMORY_BANDWIDTH_PRESSURE_CLASS = 172,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_COMPUTE_PRESSURE_CLASS = 173,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_PIPELINE_LATENCY_PRESSURE_CLASS = 174,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_CURRENT_OUTSTANDING_DEPTH = 175,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_MAX_OUTSTANDING_DEPTH = 176,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_LOOKAHEAD_REQUESTED = 177,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_LOOKAHEAD_LIMIT = 178,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_TRANSFER_OVERLAP_AVAILABLE = 179,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_TRUE_MULTI_QUEUE_SELECTED = 180,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_UNSAFE_TO_REUSE = 181,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_YIELD_REQUESTED = 182,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DECISION_SUCCESS = 183,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DECISION_STATE = 184,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DECISION_GRANT = 185,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DECISION_REASON = 186,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DECISION_ALLOWED_OUTSTANDING_DEPTH = 187,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DECISION_LOOKAHEAD_ALLOWED = 188,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DECISION_BACKPRESSURE_APPLIED = 189,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DECISION_YIELD_REQUIRED = 190,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DIAG_GRANTED_COUNT = 191,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DIAG_DENIED_COUNT = 192,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DIAG_BACKPRESSURE_COUNT = 193,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DIAG_YIELD_COUNT = 194,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DIAG_FAILED_COUNT = 195,
  PROM_DOM_KEY_INDEX_SGEMM_LEASE_DIAG_LOOKAHEAD_BLOCKED_REASON = 196,
  PROM_DOM_KEY_INDEX_COUNT = 197,
};
