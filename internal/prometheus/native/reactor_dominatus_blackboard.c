...
enum {
  ...
  PROM_DOM_KEY_INDEX_SLOT_STATE = 45,
  PROM_DOM_KEY_INDEX_SLOT_GENERATION = 46,
  PROM_DOM_KEY_INDEX_SLOT_VALID = 47,
  PROM_DOM_KEY_INDEX_SLOT_CURRENT_ID = 48,
  PROM_DOM_KEY_INDEX_SLOT_NEXT_ID = 49,
  PROM_DOM_KEY_INDEX_SLOT_FAILURE_REASON = 50,
  PROM_DOM_KEY_INDEX_QUEUE_COMPUTE_FAMILY = 51,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_FAMILY = 52,
  PROM_DOM_KEY_INDEX_QUEUE_DEDICATED_AVAILABLE = 53,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_POLICY = 54,
  PROM_DOM_KEY_INDEX_QUEUE_HANDOFF_COUNT = 55,
  PROM_DOM_KEY_INDEX_QUEUE_FAMILIES_DIFFER = 56,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_SUPPORTED = 57,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_DISABLED_BY_CONFIG = 58,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_WORKLOAD_LARGE_ENOUGH = 59,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_SYNC_OWNERSHIP_SUPPORTED = 60,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_FALLBACK_AVAILABLE = 61,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_UPLOAD_ONLY_ELIGIBLE = 62,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_UPLOAD_READBACK_SUPPORTED = 63,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_POLICY_SELECTED = 64,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_FALLBACK_REASON = 65,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_QUEUE_USED = 66,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_COMPUTE_WAIT_COUNT = 67,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_FAILURE_SLOT_ID = 68,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_FAILURE_REASON = 69,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_FAILURE_COUNT = 70,
  PROM_DOM_KEY_INDEX_QUEUE_ASYNC_TRANSFER_COMPLETE = 71,
  PROM_DOM_KEY_INDEX_QUEUE_ASYNC_TRANSFER_COMPLETION_GENERATION = 72,
  PROM_DOM_KEY_INDEX_MEMORY_REQUIRED_CAPACITY = 73,
  PROM_DOM_KEY_INDEX_MEMORY_BUDGET = 74,
  PROM_DOM_KEY_INDEX_MEMORY_HEADROOM = 75,
  PROM_DOM_KEY_INDEX_MEMORY_INVALIDATION_FLAGS = 76,
  PROM_DOM_KEY_INDEX_MEMORY_M35_FIXED_HEADROOM = 77,
  PROM_DOM_KEY_INDEX_MEMORY_M35_PULL_LAG_HEADROOM = 78,
  PROM_DOM_KEY_INDEX_MEMORY_M35_SERIAL_HEADROOM = 79,
  PROM_DOM_KEY_INDEX_MEMORY_M35_REQUIRED_FIXED = 80,
  PROM_DOM_KEY_INDEX_MEMORY_M35_REQUIRED_PULL_LAG = 81,
  PROM_DOM_KEY_INDEX_MEMORY_M35_REQUIRED_SERIAL = 82,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_REASON_CODE = 83,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_COUNTER = 84,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_LAST_TRANSITION = 85,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_SELECTED_LAYOUT_FORMAT = 86,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_TAIL_COUNT_LAST = 87,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_TAIL_COUNT_TOTAL = 88,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_PADDED_LANE_COUNT_LAST = 89,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_PADDED_LANE_COUNT_TOTAL = 90,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_PADDING_WASTE_PERMILLE_LAST = 91,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_MODE_BUDGET_DENIALS = 92,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_ROW_MAJOR_CHECK_FAILURES = 93,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_SELECTION_COUNT = 94,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_FALLBACK_REASON_PADDING_WASTE = 95,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_FALLBACK_REASON_SMALL_SHAPE = 96,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_FALLBACK_REASON_CAPABILITY_MISSING = 97,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_FALLBACK_REASON_FALLBACK_REQUIRED = 98,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_PACKED4_FALLBACK_REASON_MODE_BUDGET_DENIED = 99,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_FP16_MAX_ABSOLUTE_ERROR_BITS = 100,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_FP16_MAX_RELATIVE_ERROR_BITS = 101,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_FP16_AGGREGATE_ERROR_BITS = 102,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_FP16_WORST_CASE_ELEMENT_INDEX = 103,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_FP16_K_ERROR_GROWTH_BITS = 104,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_FP16_CANCELLATION_RISK_BITS = 105,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_FP16_TOLERANCE_KNOWN = 106,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_FP16_TOLERANCE_PASS = 107,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_FP16_FALLBACK_REASON_DETAIL = 108,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_FP16_SELECTED_CANDIDATE = 109,
  PROM_DOM_KEY_INDEX_FFT_RESERVED = 110,
  PROM_DOM_KEY_INDEX_COUNT = 111,
};
