...
enum {
  ...
  PROM_DOM_KEY_INDEX_SLOT_STATE = 7,
  PROM_DOM_KEY_INDEX_SLOT_GENERATION = 8,
  PROM_DOM_KEY_INDEX_SLOT_VALID = 9,
  PROM_DOM_KEY_INDEX_SLOT_CURRENT_ID = 10,
  PROM_DOM_KEY_INDEX_SLOT_NEXT_ID = 11,
  PROM_DOM_KEY_INDEX_SLOT_FAILURE_REASON = 12,
  PROM_DOM_KEY_INDEX_QUEUE_COMPUTE_FAMILY = 13,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_FAMILY = 14,
  PROM_DOM_KEY_INDEX_QUEUE_DEDICATED_AVAILABLE = 15,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_POLICY = 16,
  PROM_DOM_KEY_INDEX_QUEUE_HANDOFF_COUNT = 17,
  PROM_DOM_KEY_INDEX_MEMORY_REQUIRED_CAPACITY = 18,
  PROM_DOM_KEY_INDEX_MEMORY_BUDGET = 19,
  PROM_DOM_KEY_INDEX_MEMORY_HEADROOM = 20,
  PROM_DOM_KEY_INDEX_MEMORY_INVALIDATION_FLAGS = 21,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_REASON_CODE = 22,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_COUNTER = 23,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_LAST_TRANSITION = 24,
  PROM_DOM_KEY_INDEX_FFT_RESERVED = 25,
  PROM_DOM_KEY_INDEX_COUNT = 26,
};
