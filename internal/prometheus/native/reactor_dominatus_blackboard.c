...
enum {
  ...
  PROM_DOM_KEY_INDEX_QUEUE_FAMILIES_DIFFER = 39,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_SUPPORTED = 40,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_DISABLED_BY_CONFIG = 41,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_WORKLOAD_LARGE_ENOUGH = 42,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_SYNC_OWNERSHIP_SUPPORTED = 43,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_FALLBACK_AVAILABLE = 44,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_UPLOAD_ONLY_ELIGIBLE = 45,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_UPLOAD_READBACK_SUPPORTED = 46,
