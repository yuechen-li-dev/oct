...
enum {
  ...
  PROM_DOM_KEY_INDEX_SLOT_STATE = 18,
  PROM_DOM_KEY_INDEX_SLOT_GENERATION = 19,
  PROM_DOM_KEY_INDEX_SLOT_VALID = 20,
  PROM_DOM_KEY_INDEX_SLOT_CURRENT_ID = 21,
  PROM_DOM_KEY_INDEX_SLOT_NEXT_ID = 22,
  PROM_DOM_KEY_INDEX_SLOT_FAILURE_REASON = 23,
  PROM_DOM_KEY_INDEX_QUEUE_COMPUTE_FAMILY = 24,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_FAMILY = 25,
  PROM_DOM_KEY_INDEX_QUEUE_DEDICATED_AVAILABLE = 26,
  PROM_DOM_KEY_INDEX_QUEUE_TRANSFER_POLICY = 27,
  PROM_DOM_KEY_INDEX_QUEUE_HANDOFF_COUNT = 28,
  PROM_DOM_KEY_INDEX_MEMORY_REQUIRED_CAPACITY = 29,
  PROM_DOM_KEY_INDEX_MEMORY_BUDGET = 30,
  PROM_DOM_KEY_INDEX_MEMORY_HEADROOM = 31,
  PROM_DOM_KEY_INDEX_MEMORY_INVALIDATION_FLAGS = 32,
  PROM_DOM_KEY_INDEX_MEMORY_M35_FIXED_HEADROOM = 33,
  PROM_DOM_KEY_INDEX_MEMORY_M35_PULL_LAG_HEADROOM = 34,
  PROM_DOM_KEY_INDEX_MEMORY_M35_SERIAL_HEADROOM = 35,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_REASON_CODE = 36,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_COUNTER = 37,
  PROM_DOM_KEY_INDEX_DIAGNOSTICS_LAST_TRANSITION = 38,
  PROM_DOM_KEY_INDEX_FFT_RESERVED = 39,
  PROM_DOM_KEY_INDEX_COUNT = 40,
};
...
static const prom_dom_key_info k_key_info[PROM_DOM_KEY_INDEX_COUNT] = {
    ...
    {PROM_DOM_KEY_SLOT_FAILURE_REASON, PROM_DOM_DOMAIN_SLOT, 0u},
