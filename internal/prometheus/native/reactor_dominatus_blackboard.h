...
typedef enum prom_dom_key {
  ...
  PROM_DOM_KEY_SGEMM_FACT_FORCE_DIRECT_REASON = 0x0137,
  PROM_DOM_KEY_SGEMM_FACT_FORCE_STAGED = 0x0138,
  PROM_DOM_KEY_SGEMM_FACT_FORCE_TILED = 0x0139,
  PROM_DOM_KEY_SGEMM_FACT_TILED_SHAPE = 0x013A,
  PROM_DOM_KEY_SGEMM_FACT_SOFTWARE_VULKAN = 0x013B,
  PROM_DOM_KEY_SGEMM_FACT_POLICY_MODE = 0x013C,
  PROM_DOM_KEY_SGEMM_JUDGMENT_SUCCESS = 0x013D,
  PROM_DOM_KEY_SGEMM_JUDGMENT_ERROR_DETAIL = 0x013E,
  PROM_DOM_KEY_SGEMM_JUDGMENT_REQUESTED_PATH = 0x013F,
  PROM_DOM_KEY_SGEMM_JUDGMENT_SELECTED_PATH = 0x0140,
  PROM_DOM_KEY_SGEMM_JUDGMENT_COMPUTE_MODE = 0x0141,
  PROM_DOM_KEY_SGEMM_JUDGMENT_FINAL_DETAIL = 0x0142,
  PROM_DOM_KEY_SGEMM_JUDGMENT_USED_FALLBACK_TO_DIRECT = 0x0143,
  PROM_DOM_KEY_SGEMM_JUDGMENT_WINNING_CANDIDATE_INDEX = 0x0144,
  PROM_DOM_KEY_SGEMM_JUDGMENT_WINNING_SCORE = 0x0145,
  PROM_DOM_KEY_SGEMM_LEASE_WORKER_ID = 0x0146,
  PROM_DOM_KEY_SGEMM_LEASE_SLOT_ID = 0x0147,
  PROM_DOM_KEY_SGEMM_LEASE_ENTRY_ID = 0x0148,
  PROM_DOM_KEY_SGEMM_LEASE_SHAPE_CLASS = 0x0149,
  PROM_DOM_KEY_SGEMM_LEASE_DEVICE_BAND = 0x014A,
  PROM_DOM_KEY_SGEMM_LEASE_SELECTED_RECIPE_VARIANT = 0x014B,
  PROM_DOM_KEY_SGEMM_LEASE_REQUESTED_RESOURCE_CLASS = 0x014C,
  PROM_DOM_KEY_SGEMM_LEASE_REGISTER_PRESSURE_CLASS = 0x014D,
  PROM_DOM_KEY_SGEMM_LEASE_SHARED_MEMORY_PRESSURE_CLASS = 0x014E,
  PROM_DOM_KEY_SGEMM_LEASE_MEMORY_BANDWIDTH_PRESSURE_CLASS = 0x014F,
  PROM_DOM_KEY_SGEMM_LEASE_COMPUTE_PRESSURE_CLASS = 0x0150,
  PROM_DOM_KEY_SGEMM_LEASE_PIPELINE_LATENCY_PRESSURE_CLASS = 0x0151,
  PROM_DOM_KEY_SGEMM_LEASE_CURRENT_OUTSTANDING_DEPTH = 0x0152,
  PROM_DOM_KEY_SGEMM_LEASE_MAX_OUTSTANDING_DEPTH = 0x0153,
  PROM_DOM_KEY_SGEMM_LEASE_LOOKAHEAD_REQUESTED = 0x0154,
  PROM_DOM_KEY_SGEMM_LEASE_LOOKAHEAD_LIMIT = 0x0155,
  PROM_DOM_KEY_SGEMM_LEASE_TRANSFER_OVERLAP_AVAILABLE = 0x0156,
  PROM_DOM_KEY_SGEMM_LEASE_TRUE_MULTI_QUEUE_SELECTED = 0x0157,
  PROM_DOM_KEY_SGEMM_LEASE_UNSAFE_TO_REUSE = 0x0158,
  PROM_DOM_KEY_SGEMM_LEASE_YIELD_REQUESTED = 0x0159,
  PROM_DOM_KEY_SGEMM_LEASE_DECISION_SUCCESS = 0x015A,
  PROM_DOM_KEY_SGEMM_LEASE_DECISION_STATE = 0x015B,
  PROM_DOM_KEY_SGEMM_LEASE_DECISION_GRANT = 0x015C,
  PROM_DOM_KEY_SGEMM_LEASE_DECISION_REASON = 0x015D,
  PROM_DOM_KEY_SGEMM_LEASE_DECISION_ALLOWED_OUTSTANDING_DEPTH = 0x015E,
  PROM_DOM_KEY_SGEMM_LEASE_DECISION_LOOKAHEAD_ALLOWED = 0x015F,
  PROM_DOM_KEY_SGEMM_LEASE_DECISION_BACKPRESSURE_APPLIED = 0x0160,
  PROM_DOM_KEY_SGEMM_LEASE_DECISION_YIELD_REQUIRED = 0x0161,
  PROM_DOM_KEY_SGEMM_LEASE_DIAG_GRANTED_COUNT = 0x0162,
  PROM_DOM_KEY_SGEMM_LEASE_DIAG_DENIED_COUNT = 0x0163,
  PROM_DOM_KEY_SGEMM_LEASE_DIAG_BACKPRESSURE_COUNT = 0x0164,
  PROM_DOM_KEY_SGEMM_LEASE_DIAG_YIELD_COUNT = 0x0165,
  PROM_DOM_KEY_SGEMM_LEASE_DIAG_FAILED_COUNT = 0x0166,
  PROM_DOM_KEY_SGEMM_LEASE_DIAG_LOOKAHEAD_BLOCKED_REASON = 0x0167,
