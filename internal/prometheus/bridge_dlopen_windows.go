...
#include <stdlib.h>
#include <string.h>
#include "native/prometheus_bridge_abi.h"
...
static int oct_prom_call_gemma4e2b_input_rmsnorm(FARPROC symbol,
	uintptr_t handle,
	const float* input,
	const float* weight,
	float* output,
...
static int oct_prom_call_gemma4e2b_rope(FARPROC symbol, uintptr_t handle,
...
static int oct_prom_call_gemma4e2b_head_rmsnorm_rope(FARPROC symbol, uintptr_t handle,
