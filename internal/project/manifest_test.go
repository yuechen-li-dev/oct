...
func TestLoadValidatesPackageKindSemantics(t *testing.T) {
	cases := []struct {
		...
		{name: "application Kind accepted", kindLiteral: "application", includeKind: true},
		...
		{name: "EntryMilestone rejected for application", kindLiteral: "application", includeKind: true, entryLiteral: "M0", includeEntryMilestone: true, wantErr: true, wantErrContent: "EntryMilestone"},
