...
func TestCheckRejectsInvalidM41aFlowStaticSurface(t *testing.T) {
	...
	assertTypeErrorContains(t, "flow BadBoardType() -> Int { board { Slots: Complex[] } state S { return 0 } } fn Main() -> Int { return 0 }", "flow BadBoardType board field Slots: board field type Complex is not a deterministic persistent FLOW value")
