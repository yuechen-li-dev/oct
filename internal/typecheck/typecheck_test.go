...
func TestCheckRejectsInvalidM41aFlowStaticSurface(t *testing.T) {
	...
	assertTypeErrorContains(t, "flow BadBoardType() -> Int { board { Slots: Int[] } state S { return 0 } } fn Main() -> Int { return 0 }", "flow BadBoardType board field Slots: board fields must be scalar Bool, String, Int/Int<D>, or Float/Float<D>")
