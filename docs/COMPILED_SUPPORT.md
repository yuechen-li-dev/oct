...
- Wrapper sidecar M0 architecture is documented in `docs/internal/compiled_wrapper_sidecar.md`; implementation probe for compiled wrapper execution remains pending and scoped to a single builtin (`FileReadText`).
