...
- **Octxiliary sidecar-backed compiled (`... ! Error`):** `FileReadText`, `FileWriteText`, `FileReadLines`, `FileWriteLines`, `FileDelete`, `DirectoryMake`, `DirectoryMakeAll`.
- **Deferred wrapper builtins in this family:** `FileReadBytes`, `FileWriteBytes`, `DirectoryList`, `DirectoryRemoveAll`.
