// concept-vulkan generates or checks the bounded M1 / EVT1 conformance artifacts.
package main
...
func main() {
	...
	flag.StringVar(&mode, "mode", "m1", "compiler mode: m1, evt1-m1a, evt1-m1b-a, evt1-m1b-b, evt1-m1b-c, evt1-m1b-d, or evt1-dragongod-m0")
	flag.Parse()
...
func compile(mode, source string, body []byte) (conceptvulkan.Outputs, error) {
	...
	case "evt1-m1a", "evt1-m1b-a", "evt1-m1b-b", "evt1-m1b-c", "evt1-m1b-d", "evt1-dragongod-m0":
